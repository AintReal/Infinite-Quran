    ...
    <div className="flex items-center justify-center gap-3">
      {buttons.map((b) => (
        <a
          ...
          title={b.label}
          className={`${b.bg} flex h-10 w-10 items-center justify-center rounded-full text-white shadow-md transition hover:opacity-80`}
        >
          {b.icon}
        </a>
      ))}
      <button
        onClick={copy}
        title="نسخ الرابط"
        className="flex h-10 w-10 items-center justify-center rounded-full bg-gray-500 text-white shadow-md transition hover:opacity-80"
      >
